...
var_meta = dict(
    ...
    WindForcingX    = Variable("Zonal forcing on ice by wind stress", dims, "N"), #??? right?
    WindForcingY    = Variable("Meridional forcing on ice by wind stress", dims, "N"), #??? unit correct
