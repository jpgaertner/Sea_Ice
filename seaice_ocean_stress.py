...
def ocean_stress(uIce, vIce, uVel, vVel, Area, fu, fv):
    ...
    fuLoc = 0.5 * (cDrag[OLy:-OLy,OLx:-OLx] + cDrag[OLy:-OLy,OLx+1:-OLx+1]) * cosWat * (uIce[OLy:-OLy,OLx:-OLx] - uVel[OLy:-OLy,OLx:-OLx]) - np.sign(fCori) * sinWat * 0.5 * (cDrag[OLy:-OLy,OLx:-OLx] * 0.5 * (vIce[OLy:-OLy,OLx:-OLx] - vVel[OLy:-OLy,OLx:-OLx] + vIce[OLy+1:-OLy+1,OLx:-OLx] - vVel[OLy+1:-OLy+1,OLx:-OLx]) + cDrag[OLy:-OLy,OLx:-OLx] * 0.5 * (vIce[OLy:-OLy,OLx-1:-OLx-1] - vVel[OLy:-OLy,OLx-1:-OLx-1] + vIce[OLy+1:-OLy+1,OLx-1:-OLx-1] - vVel[OLy+1:-OLy+1,OLx-1:-OLx-1]))
    fvLoc = 0.5 * (cDrag[OLy:-OLy,OLx:-OLx] + cDrag[OLy-1:-OLy-1,OLx:-OLx]) * cosWat * (vIce[OLy:-OLy,OLx:-OLx] - vVel[OLy:-OLy,OLx:-OLx]) + np.sign(fCori) * sinWat * 0.5 * (cDrag[OLy:-OLy,OLx:-OLx] * 0.5 * (uIce[OLy:-OLy,OLx:-OLx] - uVel[OLy:-OLy,OLx:-OLx] + uIce[OLy:-OLy,OLx+1:-OLx+1] - uVel[OLy:-OLy,OLx+1:-OLx+1]) + cDrag[OLy:-OLy,OLx:-OLx] * 0.5 * (uIce[OLy-1:-OLy-1,OLx:-OLx] - uVel[OLy-1:-OLy-1,OLx:-OLx] + uIce[OLy-1:-OLy-1,OLx+1:-OLx+1] - uVel[OLy-1:-OLy-1,OLx+1:-OLx+1]))
    ...
    fu[OLy:-OLy,OLx:-OLx] = (1 - areaW) * fu[OLy:-OLy,OLx:-OLx] + areaW * fuLoc   #is fu, fv an input (from previous iteration)?
